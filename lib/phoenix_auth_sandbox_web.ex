defmodule PhoenixAuthSandboxWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: PhoenixAuthSandboxWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/phoenix_auth_sandbox_web/templates",
        namespace: PhoenixAuthSandboxWeb

      # Import convenience functions from controllers
      import Phoenix.Controller, only: [get_flash: 1, get_flash: 2, view_module: 1]

      import PhoenixAuthSandboxWeb.ErrorHelpers
      import PhoenixAuthSandboxWeb.Gettext
      alias PhoenixAuthSandboxWeb.Router.Helpers, as: Routes
    end
  end
